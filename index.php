...
<body>
  ...
  <div id="wrap">
    <div id="content">
      <div style="text-align: right"><a style="padding: 0;" href="logout.php">ログアウト</a></div>
      <div style="margin-top:1em;text-align: right"><a style="padding: 0;" href="quit.php">退会する</a></div>
